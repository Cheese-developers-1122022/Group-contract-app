            ...
            <div className="">
              ...
              >
                ...
                <div className="flex flex-col md:gap-1">
                  ...
                  <div className=" relative ">
                    <SlCalender className=" absolute text-gray-500 top-2 left-2" />
                ...
                <div className="flex flex-col md:gap-1">
                  ...
                  <div className="relative">
                    <BsPersonWorkspace className=" absolute text-gray-500 top-2 left-2" />
                ...
                <div className="flex flex-col md:gap-1">
                  ...
                  <div className="relative">
                    <BsBuildings className=" absolute text-gray-500 top-2 left-2" />
                ...
                <div className="flex flex-col md:gap-1">
                  ...
                  <div className="relative">
                    <GoNote className=" absolute text-gray-500 top-2 left-2" />
                    <input
                      type="text"
                      id="note"
                      value={note}
